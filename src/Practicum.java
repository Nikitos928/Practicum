...
class Practicum {
    ...
    private static void addUser() {
        ...
        } catch (ValidateNameException t) {
            System.out.println("Ошибка валидации имени: " + t.getMessage());
        }catch (ValidatePasswordException y) {
            System.out.println("Ошибка валидации пароля: " + y.getMessage());
